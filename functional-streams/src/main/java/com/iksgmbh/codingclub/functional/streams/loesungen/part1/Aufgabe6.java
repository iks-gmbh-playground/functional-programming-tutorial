...
public class Aufgabe6 {
    public static void main(String[] args) {
        ...
        var fahrzeugeInsgesamt = alleParkplaetze.stream()
                .flatMap(p -> p.getFahrzeuge().stream())
                .count();
        System.out.println("Fahrzeuge insgesamt: " + fahrzeugeInsgesamt);

        fahrzeugeInsgesamt = alleParkplaetze.stream()
                .mapToLong(p -> p.getFahrzeuge().size())
                .sum();
        System.out.println("Fahrzeuge insgesamt: " + fahrzeugeInsgesamt);
